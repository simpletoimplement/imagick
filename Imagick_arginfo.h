...
#if PHP_VERSION_ID >= 80000
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Imagick_clutImageWithInterpolateMethod, 0, 2, _IS_BOOL, 0)
#else
ZEND_BEGIN_ARG_INFO_EX(arginfo_class_Imagick_clutImageWithInterpolateMethod, 0, 0, 2)
#endif
...
#endif
#if MagickLibVersion >= 0x700
ZEND_METHOD(Imagick, clutImageWithInterpolateMethod);
#endif
#if MagickLibVersion > 0x635
...
#endif
#if MagickLibVersion >= 0x700
	ZEND_ME(Imagick, clutImageWithInterpolateMethod, arginfo_class_Imagick_clutImageWithInterpolateMethod, ZEND_ACC_PUBLIC)
#endif
#if MagickLibVersion > 0x635
